    ...
    <div style={{
      ...
      >
        ...
        <div style={{
          ...
          background: 'linear-gradient(90deg, var(--emerald), var(--accent-2), var(--accent))',
          borderRadius: 'var(--radius-lg) var(--radius-lg) 0 0',
        }} />

        <div style={{
          width: 40, height: 40,
          background: 'linear-gradient(135deg, var(--emerald), var(--accent-2))',
          borderRadius: 11,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            ...
            <input type="password" name="password" value={form.password} onChange={handleChange} placeholder="At least 8 characters" required />
          </div>
          <div>
